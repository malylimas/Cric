              ...
              <tr>
                ...
                <td>
                  <div class="btn-group" role="group" aria-label="...">
                     <a type="button" class="btn btn-primary" href="modificar/{{$cita->id}}">Modificar</a>
                      @if($cita->trashed())
                    <a type="button" class="btn btn-success" href="habilitar/{{$cita->id}}" >Habilitar</a>
                    @else
                    <a type="button" class="btn btn-danger" href="eliminar/{{$cita->id}}" >Deshabilitar</a>
                    @endif                     
                   </div>
