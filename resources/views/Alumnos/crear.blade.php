...
<form action="/alumnos" method="Post" role="form">
  {{ csrf_field()}}
  ...
  <div class="form-group row">
    ...
    <div class="col-10">
      <input class="form-control" type="text" name="nombre" id="example-text-input" value="{{ old('nombre') }}">
    </div>
  </div>
  <div class="form-group row">
    <label for="example-text-input" class="col-2 col-form-label">Dirección Actual</label>
    <div class="col-10">
      <input class="form-control" type="text" name="direccion" id="example-text-input" value="{{ old('direccion') }}">
    </div>
  </div>
  <div id="date-container" class="form-group row">
    ...
    <div class="col-10">
      <input class="form-control" type="text" name="fechaNacimiento" id="example-text-input" value="{{ old('fechaNacimiento') }}">
    </div>
  </div>
  <div class="form-group row">
  ...
  <div class="form-group row">
    ...
    <div class="col-10">
      <input class="form-control" type="text" name="nombreEncargado" id="example-text-input" value="{{ old('nombreEncargado') }}">
    </div>
  </div>
